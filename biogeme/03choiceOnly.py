...
### Coefficients
coef_intercept = Beta('coef_intercept',0.0,-1000,1000,1)
coef_age_65_more = Beta('coef_age_65_more',0.0,-1000,1000,0)
coef_haveGA = Beta('coef_haveGA',-1.21,-1000,1000,0)
...
ASC_CAR = Beta('ASC_CAR',0.0,-10000,10000,0)
ASC_PT	 = Beta('ASC_PT',0.0,-10000,10000,1)
ASC_SM = Beta('ASC_SM',0.0,-10000,10000,0)
